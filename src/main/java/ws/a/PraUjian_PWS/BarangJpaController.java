...
import ws.a.PraUjian_PWS.exceptions.NonexistentEntityException;
...
public class BarangJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ws.a_PraUjian_PWS_jar_0.0.1-SNAPSHOTPU");
